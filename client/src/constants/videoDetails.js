const videoDetails = {
	...
	question: [
		"Everyone hates the person who is different from the crowd..personal experience\nNow Kunal also proved it right..",
		"why tf kunal saying batameez is so Funny 😂😂😂😂",
		"bhaiya aap ek video ke through bata dijiye  private college jo average hai uske bacho ko kya karna chahiye  please ..",
		"What is your college name bro?",
		"Bro which college are you from",
		"Kunal what to do if you are from core branch like mechanical/civil in an 2nd gen iit.. peers boht demotivating lag rhe and coding culture isn't great",
		"Me where my college considers 10LPA as OG😞",
		"What's your journey brother in one video?",
		"If any one in  BCA level what should he/ she do",
		"Bhaiyya meri college mae tho placement lagjati hai lekin isee badi badi companies nai aati. Like 5-7 lpa placements aate hai. What should I do to get best out of it.",
		"Bhaya dsa ka remaining kab daal rahe ho ,please bhaya upload kardo yarr",
		"can anyone tell what he is saying in english replying to my comment?",
		"Hi kunal how to to manage time in 1st year ?",
		"Bro what's wrong whn u make a same video in English 🥲 how could south people get what u talking",
	],
	feedback: [
		{
			sentiment: "neutral",
		...
		},
		{
			...
			comment: ["Mait me ml wali baat to sai hai 😂"],
		},
		{
			sentiment: "negative",
			sentiment_explain: {
		...
		},
		{
			...
			comment: [
				"Bhai humara teacher to hume cllg ka wifi bhi use nhi karne deta tha, bhaag ke jata tha band karne 😂",
			],
		},
		{
			sentiment: "positive",
		...
		},
		{
			...
			comment: ["Vai ohh enargy khaya ha...😊"],
		},
		{
			sentiment: "neutral",
			sentiment_explain: {
		...
		},
		{
			...
			comment: [
				"mere department ki coordinator h ek , mene jbh usko bola ki meri ek acchi jgah internship lgg gyi h or 5 days working h \nto usne bola 75% honi chahie baaki tum kuch bhi kro i don't care   , issi chakkar me meri 3 internships chot gyi 😣\nlekin mene 3 remote internships dhoond li orr vo complete krli 😁",
			],
		},
		{
			sentiment: "negative",
		...
		},
		{
			...
			comment: [
				"Aaj college ne asli rang dikha diya... Koi nahi, aaj ratbhar rounga kal subah heal ho jaaunga aur fir apne apne raaste... Rukte nahi apun💪",
			],
		},
		{
			sentiment: "negative",
		...
		},
		{
			...
			comment: [
				"You are great for gossip dude 🤣🤣.... Seriously, I am loving you Hindi wala channel and I am relating to each and every word😂. I will definately meet u once.",
			],
		},
		{
			sentiment: "neutral",
		...
		},
		{
			...
			comment: ["4 saal mein YouTube bahut help karega💯"],
		},
		{
			sentiment: "negative",
			sentiment_explain: {
		...
		},
		{
			...
			comment: [
				"1:45 this is in my college a lot all are rude not a single teacher listen they put back if you have low attendance 🥲😭🥺",
			],
		},
		{
			sentiment: "neutral",
		...
		},
		{
			...
			comment: [
				"Mai BSc wala hu, but hamari teachers supportive hai saare ke saare ✌️, placement ka P bhi nahi hai hamare yaha and college email bhi nahi milta yaha pr toh, baaki sb theek he chal raha hai hamare yaha",
			],
		},
		{
			sentiment: "negative",
		...
		},
		{
			...
			comment: [
				"This is so relatable Kunal my college was also like yours",
			],
		},
		{
			sentiment: "neutral",
		...
		},
		{
			...
			comment: ["ML wali baat, i can relate 😅😅"],
		},
		{
			sentiment: "positive",
			sentiment_explain: {
			...
			comment: [
				"It's so relatable even though in Pakistan. I'm studying in the same college scenario Which you have mentioned about your college 😄. But fortunately, I following you and showing the same attitude \"Yes, No, Okay\" 😂. \nBtw, Love ♥ your content and whatever you advice!",
			],
		},
		{
			sentiment: "positive",
		...
		},
		{
			...
			comment: [
				"So that's the reason, i follow you😇 and i follow you with heart ❤️",
			],
		},
		{
			sentiment: "negative",
		...
		},
		{
			...
			comment: ["Highly relatable Kunal Bhai 😂"],
		},
		{
			sentiment: "neutral",
			sentiment_explain: {
			...
			comment: [
				"same bhai mere college me bhi same hota ha. Bina machine learning ke koi matlab ni project ka😂😂",
			],
		},
		{
			sentiment: "neutral",
		...
		},
		{
			...
			comment: [
				"Mera college to student email bhi nahi deta placements ki to baat hi chod do bhai kyu mere ghar walonko paisa barbaad karna hai pata nahi hopefully bca kar raha hu mai engineering nahi.\n\nEdit: Aaj hi demo practical exam hua aur muze java nahi aati hai itni sorry @kunal Kushwaha Hindi 😅 So I'm a MERN stack Dev & Igot started working on really great project which can higher my chances of getting hired so my focus was there so she asked me questions for viva & I failed to answer that so she asked me what do you know I said javascript then her reply was hilarious that then you should know java if you can work with javascript so best thing is gadho ke samne gita mat padho I said ok yes mam sorry mam like kunal said in the video & moved on  & stumbled upon the video right after arriving from college 😂😂",
			],
		},
		{
			sentiment: "negative",
			...
			comment: [
				"Sir your commclassroom website is not working i was preparing from that please 🙏 continue it sir",
			],
		},
		{
			sentiment: "positive",
		...
		},
		{
			...
			comment: [
				"Kunal be like:(to teacher) aao dekh lo tumara baap bhi mera kuch nhi ukaad skta🤣😂",
			],
		},
		{
			sentiment: "negative",
		...
		},
		{
			...
			comment: ["Bhaiya please try to complete DSA bootcamp 🙏"],
		},
		{
			sentiment: "positive",
			sentiment_explain: {
		...
		},
		{
			...
			comment: ["same problem major projects me only ml or dl 😥😥😥😥"],
		},
		{
			sentiment: "neutral",
			sentiment_explain: {
		...
		},
		{
			...
			comment: [
				"Let's say Kunal presented the fact short to  the point... it's better to recognise early  n decide better option 💫 (I'm already ignoring every staff from 2nd sem haha) \n\nPS : nyc glasses 🤓 Kunal",
			],
		},
		{
			sentiment: "neutral",
		...
		},
		{
			...
			comment: [
				"One thing I would like to say is that Kunal is from mait, delhi. After I got over with my jee, a broker called me and said he would directly admit me in mait it's just I have to pay 17 lakhs donation, 😂😂😂",
			],
		},
		{
			sentiment: "negative",
		...
		},
		{
			...
			comment: [
				"College ignored DSA. I watched DSA bootcamp here and that is also getting ignored.🙃",
			],
		},
		{
			sentiment: "negative",
		...
		},
		{
			...
			comment: ["Teacher offend hogyi faltu ke ..🤣"],
		},
		{
			sentiment: "neutral",
			sentiment_explain: {
		...
		},
		{
			...
			comment: ["From the bottom of my heart 🙏🏻 thank you bhaiya"],
		},
		{
			sentiment: "positive",
			sentiment_explain: {
		...
		},
		{
			...
			comment: [
				"Realte ker skta hu bhai Same problem hai Hamare college Mai ditto same hai bro😢",
			],
		},
		{
			sentiment: "neutral",
		...
		},
		{
			...
			comment: ["Un ko nahe pata kaa kunal hamara papa haa😅😂"],
		},
		{
			sentiment: "neutral",
			sentiment_explain: {
		...
		},
		{
			...
			comment: [
				"Baaki bache hue dsa ke topics kaha se padhna hai atleast ye batado bhai 😭",
			],
		},
		{
			sentiment: "neutral",
			...
			comment: [
				"Kunal bhai\n\nYou were about to use CHU.... word...at 1:18 to 1:22 🤣",
			],
		},
		{
			sentiment: "neutral",
		...
		},
		{
			...
			comment: [
				"I can relate with each words as i am in a college with 90% attendance criteria , 9 to 5 classes monday to Saturday teaches like school students not a single  event happen and placement training only reasoning and aptitude. literally wasted 3 years hustling for nothing 🥲🥲",
			],
		},
		{
			sentiment: "neutral",
		...
		},
		{
			...
			comment: ["Related with ML project 😌🙋"],
		},
		{
			sentiment: "neutral",
			sentiment_explain: {
		...
		},
		{
			...
			comment: [
				"Was just solving your array assignments and then got your notification😝",
			],
		},
		{
			sentiment: "positive",
